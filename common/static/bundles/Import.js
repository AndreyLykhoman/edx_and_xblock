...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./common/static/js/vendor/domReady.js"), __webpack_require__("./cms/static/js/features/import/views/import.js"), __webpack_require__(0), __webpack_require__(2), __webpack_require__("./common/static/js/vendor/jQuery-File-Upload/js/jquery.fileupload.js"), __webpack_require__("./common/static/js/vendor/jquery.cookie.js"), __webpack_require__("./cms/static/cms/js/main.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (domReady, Import, $, gettext) {
    'use strict';
                ...
                add: function (e, data) {
                    ...
                    if (file.name.match(/tar\.gz$/)) {
                        $submitBtn.click(function (event) {
                            ...
                            Import.start(file.name, feedbackUrl.replace('fillerName', file.name)).then(onComplete);
