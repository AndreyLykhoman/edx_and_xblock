...
class CourseOutline {
  ...
  constructor() {
    ...
    [...document.querySelectorAll('a:not([href^="#"])')].forEach(link => link.addEventListener('click', event => {
...
/* harmony export (immutable) */ __webpack_exports__["CourseOutline"] = CourseOutline;
